...
public class OrderItem implements AdditionalDataHolder, Parsable {
    ...
    public static OrderItem createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("totalCost", (n) -> { this.setTotalCost(n.getIntegerValue()); });
        deserializerMap.put("unitCost", (n) -> { this.setUnitCost(n.getIntegerValue()); });
