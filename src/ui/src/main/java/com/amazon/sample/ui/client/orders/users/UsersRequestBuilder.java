package com.amazon.sample.ui.client.orders.users;
...
public class UsersRequestBuilder extends BaseRequestBuilder {
    ...
    public User post(@jakarta.annotation.Nonnull final UserRegistration body) {
     ...
     */
    @jakarta.annotation.Nullable
    public User post(@jakarta.annotation.Nonnull final UserRegistration body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UserRegistration body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UserRegistration body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
